...
from endpoints.taxon import create_taxon, get_taxon
from endpoints.project import create_project, get_project
...
app.add_url_rule("/taxon/create", view_func=create_taxon, methods=["POST"])
app.add_url_rule("/taxon/get", view_func=get_taxon, methods=["POST"])

app.add_url_rule("/project/create", view_func=create_project, methods=["POST"])
app.add_url_rule("/project/get", view_func=get_project, methods=["POST"])
